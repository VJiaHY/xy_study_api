...
-- ----------------------------
INSERT INTO `sys_permission` VALUES ('1', '5c8042bd6c601270b2bbd9b20bccc68b', '我的消息', '/isps/userAnnouncement', 'system/UserAnnouncementList', NULL, NULL, 1, 'sys:user:list', NULL, 3.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-04-19 10:16:00', 'admin', '2019-12-25 09:54:34', 0, 0, NULL, 0);
INSERT INTO `sys_permission` VALUES ('2', '5c8042bd6c601270b2bbd9b20bccc68b', '诗文', '', 'system/UserAnnouncementList', NULL, NULL, 1, 'show:aphorism:one', NULL, 3.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-04-19 10:16:00', 'admin', '2019-12-25 09:54:34', 0, 0, NULL, 0);
...
-- ----------------------------
INSERT INTO `sys_role_permission` VALUES (1, '1', '1', NULL, NULL, NULL);
INSERT INTO `sys_role_permission` VALUES (2, '1', '2', NULL, NULL, NULL);
...
CREATE TABLE `sys_user`  (
  ...
  `user_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1' COMMENT '用户类刑 ( 0管理员，1普通用户 ) ',
  `create_by` bigint(0) NULL DEFAULT NULL COMMENT '创建人的用户id ',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint(0) NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `del_f1ag` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '删除标志(0代表未删除，1代表已删除)',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (2, '1', '1', '$2a$10$w3W/DxRuV6VOY.9xXSvqtOYOokYIknpeBZlLGKQaA16hmJvAtnbdK', '0', NULL, '188795451', NULL, NULL, '1', NULL, NULL, NULL, NULL, '0');
